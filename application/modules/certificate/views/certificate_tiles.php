...
foreach($data as $row)
{
                ...
                echo "<a href='http://localhost/meplus/templating/describe/".$row['fun']."'>";
                echo "<li class='col-md-3 col-sm-6'>";
                echo "<div class='single-service wow slideInUp'>";
                echo "<span class='fa fa-edit service-icon'></span>";
                echo " <h4 class='service-title'>".$row['title']."</h4>";
                echo " <p>".$row['short_description']."</p>";//[short_description]
                echo "</div>";
                echo "</li>";
$i++;
}
